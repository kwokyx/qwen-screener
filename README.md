# Stock Screening System Based on Qianwen

**基于千问的股票筛选系统** — A-share data management, factor screening, natural-language screening (LLM), portfolio watchlist, and strategy backtest. Built with **FastAPI + Vue 3 + AKShare**. For academic / research use only; not investment advice.

| | |
|---|---|
| Maintainer | [@inggg19](https://github.com/inggg19) |
| Status | [docs/STATUS.md](docs/STATUS.md) |
| API | [docs/API.md](docs/API.md) |
| Course mapping | [docs/课题要求对照.md](docs/课题要求对照.md) |
| License | [MIT](LICENSE) |
